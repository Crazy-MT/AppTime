...
import com.mt.time.detail.DetailActivity;
...
public class FloatView extends LinearLayout {
    ...
    private TextView packageName, className, appName;
    ...
    private void initView() {
        ...
        findViewById(R.id.start_detail).setOnClickListener(new OnClickListener() {
            @Override
            public void onClick(View view) {
                mContext.startActivity(new Intent(mContext , DetailActivity.class).addFlags(Intent.FLAG_ACTIVITY_NEW_TASK));
            }
        });
    }

    public void updateDisplay(String packageNameStr, String classNameStr , String appNameStr){
